package com.biletflow.biletflow.common.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.biletflow.biletflow.iam.persistence..*)
        || within(com.biletflow.biletflow.iam.application..*)
        || within(com.biletflow.biletflow.iam.web.rest..*)
        """
    )
