...
class EventInventoryApplicationServiceTest {
    ...
    void wrongPriceCategoryCannotHoldSeat() {
        ...
        EventInventoryApplicationService service = new EventInventoryApplicationService(inventoryRepository, ticketTypeRepository, clock);
